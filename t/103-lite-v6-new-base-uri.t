...
subtest 'URI bracket notation [addr]/mask' => sub {
    ...
    for my $input ('[192.0.2.99]/24', '[192.0.2.99/24]', '[192.0.2.99] 24', '[192.0.2.99]') {
        ok(!defined NetAddr::IP::Lite->new($input), "$input rejected, brackets are IPv6 only");
    }
    is("" . NetAddr::IP::Lite->new('[::ffff:192.0.2.99]/96'),
